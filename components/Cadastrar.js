  ...
  return ( 
    ...
    >
      ...
      <View style={styles.viewMestra}>
        ...
        <SafeAreaProvider>
          <SafeAreaView>
            <Text style={{marginTop:30,marginBottom:10,marginLeft:10, fontWeight:'bold'}}>Nome de usuário</Text>
            <TextInput
              style={styles.input}
            />
            ...
            <TextInput
              style={styles.input}
            />
            <Text style={{marginTop:20,marginBottom:10,marginLeft:10, fontWeight:'bold'}}>Email</Text>
            <TextInput
              style={styles.input}
            />
